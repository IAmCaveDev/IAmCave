...
ResourceDisplay::ResourceDisplay(Game& gameRef) : gameRef(gameRef), 
                    ...
                    food({ 70, 30 }, {1270,65 }, "assets/testbox2.png", "", 5, 20), 
                    buildingMaterial({ 70, 30 }, { 1500, 770 }, "assets/testbox2.png", "", 5, 20),
                    cavemanCapacity({ 70, 30 }, { 500, 400 }, "assets/testbox2.png", "", 5, 20){   
}
